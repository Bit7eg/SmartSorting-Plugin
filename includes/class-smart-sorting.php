...
class Smart_Sorting {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-smart-sorting-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-smart-sorting-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-smart-sorting-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-smart-sorting-public.php';

        /**
         *
         */
        require_once plugin_dir_path( dirname( __FILE__, 2 ) ).'woocommerce/woocommerce.php';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Smart_Sorting_Admin( $this->get_smart_sorting(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Smart_Sorting_Public( $this->get_smart_sorting(), $this->get_version() );

		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
        //$this->loader->add_action('woocommerce_before_shop_loop', $plugin_public, 'test');
